...
Version  : 5.48.0
Release  : 1
URL      : https://download.kde.org/stable/frameworks/5.48/kconfig-5.48.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.48/kconfig-5.48.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.48/kconfig-5.48.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1531922688
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5ConfigCore.so.5.48.0
/usr/lib64/libKF5ConfigGui.so.5
/usr/lib64/libKF5ConfigGui.so.5.48.0
