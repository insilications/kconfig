...
Requires: kconfig-libexec = %{version}-%{release}
...
%package libexec
Summary: libexec components for the kconfig package.
Group: Default

%description libexec
libexec components for the kconfig package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643460698
mkdir -p clr-build
pushd clr-build
