...
%prep
%setup -q -n kconfig-5.75.0
cd %{_builddir}/kconfig-5.75.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602688608
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kconfig-5.75.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kconfig/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kconfig-5.75.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kconfig/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kconfig-5.75.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kconfig/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kconfig-5.75.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kconfig/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kconfig-5.75.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/kconfig/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/kconfig-5.75.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kconfig/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/kconfig-5.75.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kconfig/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kconfig-5.75.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kconfig/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kconfig-5.75.0/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/kconfig/a0193e3fccf86c17dc71e3f6c0ac0b535e06bea3
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5ConfigCore.so.5.75.0
/usr/lib64/libKF5ConfigGui.so.5
/usr/lib64/libKF5ConfigGui.so.5.75.0
