...
Version  : 5.63.0
Release  : 25
URL      : https://download.kde.org/stable/frameworks/5.63/kconfig-5.63.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.63/kconfig-5.63.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.63/kconfig-5.63.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570919214
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5ConfigCore.so.5.63.0
/usr/lib64/libKF5ConfigGui.so.5
/usr/lib64/libKF5ConfigGui.so.5.63.0
