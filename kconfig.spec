...
Version  : 5.58.0
Release  : 19
URL      : https://download.kde.org/stable/frameworks/5.58/kconfig-5.58.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.58/kconfig-5.58.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.58/kconfig-5.58.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1557766170
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKF5ConfigCore.so.5.58.0
/usr/lib64/libKF5ConfigGui.so.5
/usr/lib64/libKF5ConfigGui.so.5.58.0
